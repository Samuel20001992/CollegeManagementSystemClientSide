...
import { deleteCourse_Breakdown, getCourse_Breakdowns } from '../action/course_breakdown.action';
...
export default function Course_Breakdown_Table() {
  ...
  const courseBreakdownRows =  useSelector((state) => state.course_breakdownReducer);

  const rows = courseBreakdownRows;

  const handleDelete = (id) => {
    dispatch(deleteCourse_Breakdown(id))
  }
  return (
    <Box sx={{ width: '90%' }}>
