...
export default function Application() {
  ...
  const handleSubmit = () => {
    dispatch(createApplication(apply));
  }
      ...
      <Box sx={{ width: '90%' }}>
        <Grid container spacing={1}>
          ...
          < TextField id="outlined-basic" style={{ width: '300px', align: 'left' }} label="Student Id" variant="outlined" size="small"
              onChange={(e) => {
                setApply({ ...apply, student_id: e.target.value })
              }}
        ...
        <Grid item xs={4} md={4} sm={4}>
          < TextField id="outlined-basic" style={{ width: '300px', align: 'left' }} label="Course Code" variant="outlined" size="small"
              onChange={(e) => {
                setApply({ ...apply, course_code: e.target.value })
              }}
        ...
        <Grid item xs={6} md={4} sm={6}>
                <FormControl  style={{ float:'left', marginLeft:'90px', width:'300px'}}   size="small">
                    ...
                    value={apply.item}
                            label="Item"
              onChange={(e) => setApply({ ...apply, item: e.target.value})}
                        >
                             <MenuItem value={'Make up'}>Make up</MenuItem>
                             <MenuItem value={'Delay'}>Delay</MenuItem>
                             <MenuItem value={'Grade Change'}>Grade Change</MenuItem>
                             <MenuItem value={'Suplimantary Exam'}>Suplimantary Exam</MenuItem>
        ...
        <Grid item xs={4} md={4} sm={4}>
          < TextField id="outlined-basic" style={{ width: '300px', align: 'left' }} label="Reason" variant="outlined" size="small" multiline
              onChange={(e) => {
                setApply({ ...apply, reason: e.target.value })
              }}
