...
export default function Add_Table() {
  ...
  const addRows =  useSelector((state) => state.addReducer);
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(addRows, getComparator(order, orderBy))
