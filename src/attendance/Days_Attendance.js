...
import { searchAll } from '../action/attendance.action';
...
export default function Days_Attendance(props) {
  ...
  const emptyRows =
    ...
    useEffect(()=>{
         dispatch(searchAll(props.start_day, props.start_month, props.start_year, props.end_day, props.end_month, props.end_year))
    },[currentId, dispatch])
