...
function Design_Assessment() {
  ...
  const courses =  useSelector((state) => state.course_registrationReducer);
    ...
    e.preventDefault();
    dispatch(createCourse_Breakdown(assessmentData)); 
    }
    
    const handleCourseCode = (e) => {
        setAssessmentData({ ...assessmentData, course_code: e.target.value })
    }
    return (
        <div style={{
        ...
        >
            <Grid container spacing={3}>
                ...
                <FormControl  style={{ float:'left', marginLeft:'90px', width:'300px'}}   size="small">
                    ...
                    onChange={(e) => setAssessmentData({ ...assessmentData, attendance_year: e.target.value })}
                        >
                        <MenuItem value={"1"}>1</MenuItem>
                         <MenuItem value={"2"}>2</MenuItem>
                         <MenuItem value={"3"}>3</MenuItem>   
                ...
                <FormControl  style={{ float:'left', marginLeft:'90px', width:'300px'}}   size="small">
                    ...
                    value={semester}
                    name='semester'
                    onChange={(e) => setAssessmentData({ ...assessmentData, semester: e.target.value })}
                        >
                        <MenuItem value={"1"}>1</MenuItem>
                         <MenuItem value={"2"}>2</MenuItem>
                         <MenuItem value={"3"}>3</MenuItem>   
                ...
                <FormControl  style={{ float:'left', marginLeft:'90px', width:'300px'}}   size="small">
                    ...
                    labelId="demo-simple-select-label"
                    id="demo-simple-select"
                    value= {assessmentData.course_code}
                    onChange={handleCourseCode}
                  >
                    {courses.map((course)=>{
                ...
                <FormControl  style={{ float:'left', marginLeft:'90px', width:'300px'}}   size="small">
                    ...
                    value={semester}
                    name='academic_year'
                    onChange={(e) => setAssessmentData({ ...assessmentData, academic_year: e.target.value })}
                        >
                        <MenuItem value={"1"}>1</MenuItem>
                         <MenuItem value={"2"}>2</MenuItem>
                         <MenuItem value={"3"}>3</MenuItem>   
...
export default Design_Assessment