...
import { getOneCourse } from '../action/course_registration.action';
function Course_Container() {
  ...
  const handleSearch = () =>{
    dispatch(getOneCourse(searchValue)); 
}
    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      ...
      <Grid container >
        ...
        <Grid item xs={10} md={10} sm={10} style={{float:'left'}}>
          <Typography variant='h6' style={{float:'left',  color:'gray', marginTop:'10px', marginLeft:'20px'}}>Course</Typography>
