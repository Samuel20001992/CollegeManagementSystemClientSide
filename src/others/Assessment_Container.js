    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      ...
      <Grid container >
        ...
        <Grid item xs={10} md={10} sm={10} style={{float:'left'}}>
          <Typography variant='h6' style={{float:'left',  color:'gray', marginTop:'10px', marginLeft:'20px'}}>Assessment</Typography>
...
export default Assessment_Container
